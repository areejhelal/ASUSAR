...
static StackType_t TaskStack2 [OS_TASK_SIZE_2];
static StackType_t TaskStack3 [OS_TASK_SIZE_3];
static StackType_t TaskStack4 [OS_TASK_SIZE_4];
#endif
 ...
 OsTask TaskStruct[NUMBER_OF_TASKS + 1] = {
                                 {
                                  ...
                                  .TaskType = basic,
                                      ...
                                      {
                                       .StackRef = TaskStack2,
                                       .StackSize = OS_TASK_SIZE_2,
                                       .TaskCode = (TaskFunction_t) TASK_FUNCTION_NAME(OS_TASK_NAME_2),
                                       .Priority =  OS_TASK_PRIORITY_2,
                                       .StartingPriority = OS_TASK_PRIORITY_2,
                                       .Activation = OS_TASK_ACTIVATION_2,
                                       .Schedule = OS_TASK_SCHEDULE_2,
                                       .AutoStart = OS_TASK_AUTOSTART_2,
                                       .TaskType = OS_TASK_TYPE_2,
                                      },

                                      {
                                       .StackRef = TaskStack3,
                                       .StackSize = OS_TASK_SIZE_3,
                                       .TaskCode = (TaskFunction_t) TASK_FUNCTION_NAME(OS_TASK_NAME_3),
                                       .Priority =  OS_TASK_PRIORITY_3,
                                       .StartingPriority = OS_TASK_PRIORITY_3,
                                       .Activation = OS_TASK_ACTIVATION_3,
                                       .Schedule = OS_TASK_SCHEDULE_3,
                                       .AutoStart = OS_TASK_AUTOSTART_3,
                                       .TaskType = OS_TASK_TYPE_3,
                                      },
                                      {
                                       .StackRef = TaskStack4,
                                       .StackSize = OS_TASK_SIZE_4,
                                       .TaskCode = (TaskFunction_t) TASK_FUNCTION_NAME(OS_TASK_NAME_4),
                                       .Priority =  OS_TASK_PRIORITY_4,
                                       .StartingPriority = OS_TASK_PRIORITY_4,
                                       .Activation = OS_TASK_ACTIVATION_4,
                                       .Schedule = OS_TASK_SCHEDULE_4,
                                       .AutoStart = OS_TASK_AUTOSTART_4,
                                       .TaskType = OS_TASK_TYPE_4,
                                      },
#endif
};
...
TaskType const OS_TASK_NAME_2 = (TaskType) &TaskStruct[2];
TaskType const OS_TASK_NAME_3 = (TaskType) &TaskStruct[3];
TaskType const OS_TASK_NAME_4 = (TaskType) &TaskStruct[4];
#endif
/***************************** Counter Structs ***************************************/
